...
BIN_THRESHOLDS = [25, 50, 75]
NUM_BINS = len(BIN_THRESHOLDS) + 1  # sensor value could be 0,1,2,3
...
def play_robot_action(rob, action=None):
    ...
    next_state = transform_ir_values(selected_values, thresholds=BIN_THRESHOLDS)
